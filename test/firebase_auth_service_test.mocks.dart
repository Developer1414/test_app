...
// in test_app/test/firebase_auth_service_test.dart.
...
/// A class which mocks [UserDatabaseController].
///
/// See the documentation for Mockito's code generation for more information.
class MockUserDatabaseController extends _i1.Mock
    implements _i7.UserDatabaseController {
  MockUserDatabaseController() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  void setLoading(bool? loadingState) => super.noSuchMethod(
        Invocation.method(
          #setLoading,
          [loadingState],
        ),
  ...
  @override
  _i5.Future<dynamic> createMarker(_i8.Marker? marker) => (super.noSuchMethod(
        Invocation.method(
          #createMarker,
          [marker],
        ),
  ...
  @override
  _i5.Future<dynamic> deleteAllMarkers() => (super.noSuchMethod(
        Invocation.method(
          #deleteAllMarkers,
          [],
        ),
